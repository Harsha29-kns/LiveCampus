        ...
        <div className="relative">
          ...
          <input
            ...
            className={twMerge(
              ...
              inputPaddingStyles,
              inputWidthStyles,
              'py-2 pr-10', // Always add padding right for potential icons
              className
            )}
          ...
          {(rightIcon || hasError) && (
            <div className={`absolute inset-y-0 right-0 flex items-center pr-3 ${rightIconInteractive ? '' : 'pointer-events-none'}`}>
              {hasError ? (
                <svg
